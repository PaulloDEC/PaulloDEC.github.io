...
export class UIManager {
    ...
    populateLevelList(files) {
        ...
        files.forEach(f => {
            ...
            else if (upper.startsWith('TITLE') || upper.startsWith('LOGO') || upper.startsWith('RIGEL') || upper.startsWith('LCR') || upper.startsWith('BONUS') || upper.startsWith('APOGEE') || upper.startsWith('GAMEOVER') || upper === 'BONUSSCN.MNI' || upper.startsWith('END') || upper === 'HINTS.MNI' || upper.startsWith('HY') || upper.startsWith('ITEMS') || upper.startsWith('KEYBOARD') || upper.startsWith('LOAD') || upper === 'MESSAGE.MNI' || (upper.startsWith('ORDER') && upper !== 'ORDERTXT.MNI') || upper.startsWith('PRIZES') || upper === 'STORY.MNI' || upper.startsWith('WEAPONS')) categories["Screens & Logos"].push(f);
			...
			else if (upper.endsWith ('.PAL')) categories["Palettes"].push(f);
